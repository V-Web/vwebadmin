...
<div class="item_fields">
	...
	<table class="table">
		...
		<tr>
			<th><?php echo JText::_('COM_VWEBADMIN_FORM_LBL_DOMEIN_WEBSITE'); ?></th>
			<td><?php echo $this->item->website; ?></td>
		</tr>

		<tr>
			<th><?php echo JText::_('COM_VWEBADMIN_FORM_LBL_DOMEIN_SUBSCRIPTION_START'); ?></th>
			<td><?php echo $this->item->subscription_start; ?></td>
		</tr>

		<tr>
			<th><?php echo JText::_('COM_VWEBADMIN_FORM_LBL_DOMEIN_SUBSCRIPTION_END'); ?></th>

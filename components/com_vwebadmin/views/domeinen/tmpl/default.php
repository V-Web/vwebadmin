...
$canCreate  = $user->authorise('core.create', 'com_vwebadmin') && file_exists(JPATH_COMPONENT . DIRECTORY_SEPARATOR . 'models' . DIRECTORY_SEPARATOR . 'forms' . DIRECTORY_SEPARATOR . 'domeinform.xml');
$canEdit    = $user->authorise('core.edit', 'com_vwebadmin') && file_exists(JPATH_COMPONENT . DIRECTORY_SEPARATOR . 'models' . DIRECTORY_SEPARATOR . 'forms' . DIRECTORY_SEPARATOR . 'domeinform.xml');
...
<form action="<?php echo JRoute::_('index.php?option=com_vwebadmin&view=domeinen'); ?>" method="post"
		...
		<tr>
			...
			<?php endif; ?>
				...
				<?php echo JHtml::_('grid.sort',  'COM_VWEBADMIN_DOMEINEN_SUBSCRIPTION_END', 'a.subscription_end', $listDirn, $listOrder); ?>
					...
					<th class="center">
				<?php echo JText::_('COM_VWEBADMIN_DOMEINEN_ACTIONS'); ?>
				</th>
				<?php endif; ?>
	...
	<?php if ($canCreate) : ?>
		<a href="<?php echo JRoute::_('index.php?option=com_vwebadmin&task=domeinform.edit&id=0', false, 0); ?>"

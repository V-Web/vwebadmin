 ...
 * @since  1.6
 */
class VwebadminModelDomein extends JModelItem
{
	/**
	...
	protected function populateState()
	{
		...
		{
			$id = JFactory::getApplication()->getUserState('com_vwebadmin.edit.domein.id');
		}
		else
		{
			$id = JFactory::getApplication()->input->get('id');
			JFactory::getApplication()->setUserState('com_vwebadmin.edit.domein.id', $id);
		}

		$this->setState('domein.id', $id);
		...
		{
			$this->setState('domein.id', $params_array['item_id']);
		}
	...
	{
		// Get the id.
		$id = (!empty($id)) ? $id : (int) $this->getState('domein.id');

 ...
 * @since  1.6
 */
class VwebadminModelHosting extends JModelItem
{
	/**
	...
	protected function populateState()
	{
		...
		{
			$id = JFactory::getApplication()->getUserState('com_vwebadmin.edit.hosting.id');
		}
		else
		{
			$id = JFactory::getApplication()->input->get('id');
			JFactory::getApplication()->setUserState('com_vwebadmin.edit.hosting.id', $id);
		}

		$this->setState('hosting.id', $id);
		...
		{
			$this->setState('hosting.id', $params_array['item_id']);
		}
	...
	public function &getData($id = null)
	{
		if ($this->_item === null)
		{
			...
			$this->_item->website = !empty($textValue) ? implode(', ', $textValue) : $this->_item->website;
	 ...
	 */
	public function getTable($type = 'Hosting', $prefix = 'VwebadminTable', $config = array())
	{
	...
	{
		// Get the id.
		$id = (!empty($id)) ? $id : (int) $this->getState('hosting.id');

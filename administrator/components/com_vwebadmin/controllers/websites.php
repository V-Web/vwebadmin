 ...
 * @since  1.6
 */
class VwebadminControllerWebsites extends JControllerAdmin
{
	/**
	 * Method to clone existing Websites
	 *
	 * @return void
	 */
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'website', $prefix = 'VwebadminModel', $config = array())
	{

...
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'domein.cancel') {
			Joomla.submitform(task, document.getElementById('domein-form'));
		}
		else {
			
			if (task != 'domein.cancel' && document.formvalidator.isValid(document.id('domein-form'))) {
...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="domein-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_VWEBADMIN_TITLE_DOMEIN', true)); ?>
		<div class="row-fluid">

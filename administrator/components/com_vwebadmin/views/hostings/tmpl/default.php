...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_vwebadmin&task=hostings.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'hostingList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php endif; ?>
										...
										<td>
				<a href="<?php echo JRoute::_('index.php?option=com_vwebadmin&task=hosting.edit&id='.(int) $item->id); ?>">

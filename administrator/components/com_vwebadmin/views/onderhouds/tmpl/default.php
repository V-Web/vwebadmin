...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_vwebadmin&task=onderhouds.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'onderhoudList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}

...
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'klant.cancel') {
			Joomla.submitform(task, document.getElementById('klant-form'));
		}
		else {
			
			if (task != 'klant.cancel' && document.formvalidator.isValid(document.id('klant-form'))) {
...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="klant-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_VWEBADMIN_TITLE_KLANT', true)); ?>
		<div class="row-fluid">

...
//  		wp_die(jols__("It looks like your files isn't writable, so PHP couldn't make any changes (CHMOD).", "LayerSlider"), jols__('Cannot write to file', 'LayerSlider'), array('back_link' => true) );
